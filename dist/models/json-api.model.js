...
var JsonApiModel = /** @class */ (function () {
    ...
    Object.defineProperty(JsonApiModel.prototype, "meta", {
        get: function () {
            return new __1.JsonApiMetaModel(this.data);
        },
        enumerable: true,
        configurable: true
    });
            ...
            for (var _i = 0, hasMany_1 = hasMany; _i < hasMany_1.length; _i++) {
                ...
                if (relationship && relationship.data && relationship.data.length > 0) {
                    ...
                    for (var _a = 0, _b = Object.keys(relationship.data); _a < _b.length; _a++) {
                        ...
                        if (modelType) {
                            var relationshipModels = this.getHasManyRelationship(modelType, [relationship.data[typeIndex]], included, typeName, remainingModels);
